...
public class LoginActivity extends AppCompatActivity {
    ...
    private void isUser() {
        ...
        FirebaseDatabase rootNode = FirebaseDatabase.getInstance("https://digitalvehicle-66b90-default-rtdb.firebaseio.com");
        ...
        checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                enableLoginButton();
                Toast.makeText(getApplicationContext(), "No users found "+ error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
